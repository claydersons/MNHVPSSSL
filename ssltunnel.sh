...
echo ""
tput setaf 2 ; tput bold ; echo "6 - Desinstalar Stunnel4 " ; tput sgr0
echo ""
tput setaf 2 ; tput bold ; echo "0 - Sair " ; tput sgr0
echo ""
echo ""
tput setaf 2 ; tput bold ; echo "-------------VPSPINDA------------------" ; tput sgr0
...
echo ""
echo ""
tput setaf 2 ; tput bold ; echo "By VPSPINDA" ; tput sgr0
echo ""
echo ""
echo ""
tput setaf 2 ; tput bold ; echo "--------------------------------------------" ; tput sgr0